                        ...
                        <section class="editProfileSection ">
                            <div class="fieldGroup">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="title" name="title" value="{{$project->title}}" class="form-control  input-lg edit-profile-input"> 
                                </div>
                                <div class="form-group" id="groupdomain">
                                    <label class="" for="description">Mô tả</label>
                                    <textarea rows="5" class="form-control input-lg edit-profile-input hzUrlInput ckeditor" id="content" name="description">{{$project->description}}</textarea>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="div-image">
                                        ...
                                        <input type="hidden" name="images" class="image_data" value="{{$project->images}}">
